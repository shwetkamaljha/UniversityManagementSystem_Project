...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    UpdateTeacher() {
        ...
        try {
            ...
            while(rs.next()) {
                cEmpId.add(rs.getString("tchrId"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            Conn c = new Conn();
            String query = "select * from teacher where tchrId='"+cEmpId.getSelectedItem()+"'";
            ...
            while(rs.next()) {
                ...
                labelEmpId.setText(rs.getString("tchrId"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', qualification='"+qualification+"', Department='"+Department+"' where tchrId='"+tchrId+"'";
                Conn con = new Conn();
